...
void cg::world::camera::set_theta(float in_theta) { theta = in_theta * PI_f / 180.f; }

void cg::world::camera::set_phi(float in_phi) { phi = in_phi * PI_f / 180.f; }

void cg::world::camera::set_angle_of_view(float in_aov) { angle_of_view = in_aov * PI_f / 180.f; }
